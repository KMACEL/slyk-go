...
// ProductQuestionReorderDataForBody is
func ProductQuestionReorderDataForBody() *ProductQuestionReorderDataBody {
	return &ProductQuestionReorderDataBody{}
}

func (p *ProductQuestionReorderDataBody) SetSubsequentID(subsequentID string) *ProductQuestionReorderDataBody {
	p.SubsequentID = subsequentID
	return p
}
