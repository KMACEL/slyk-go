...
// UpdateOrderDataForBody is
func UpdateOrderDataForBody() *UpdateOrderDataBody {
	return &UpdateOrderDataBody{}
}

func (u *UpdateOrderDataBody) SetTrackingID(trackingID string) *UpdateOrderDataBody {
